    ...
    API: {
      ...
      streamResponse: async function(userMessage, conversationId, messagesContainer) {
        ...
        try {
          ...
          const streamUrl = 'https://gpt-chatbot-production-0e5c.up.railway.app/chat';
      ...
      fetchChatHistory: async function(conversationId, messagesContainer) {
        try {
          ...
          const historyUrl = `https://gpt-chatbot-production-0e5c.up.railway.app/chat?history=true&conversation_id=${encodeURIComponent(conversationId)}`;
    ...
    Auth: {
      ...
      startTokenPolling: function(conversationId, messagesContainer) {
        ...
        const poll = async () => {
          ...
          try {
            const tokenUrl = 'https://gpt-chatbot-production-0e5c.up.railway.app/auth/token-status?conversation_id=' +
